...
const CHART_PACKS = [
  ...
  { tag: "jazz", label: "Jazz", blurb: "late night" },
  { tag: "soul", label: "Soul", blurb: "warm grooves" },
  { tag: "metal", label: "Metal", blurb: "loud & proud" },
  { tag: "punk", label: "Punk", blurb: "fast & raw" },
  { tag: "folk", label: "Folk", blurb: "acoustic tales" },
  { tag: "classical", label: "Classical", blurb: "orchestral" },
  { tag: "reggae", label: "Reggae", blurb: "riddim" },
  { tag: "country", label: "Country", blurb: "story songs" },
  { tag: "house", label: "House", blurb: "four on the floor" },
  { tag: "techno", label: "Techno", blurb: "warehouse" },
  { tag: "k-pop", label: "K-pop", blurb: "idol charts" },
  { tag: "afrobeats", label: "Afrobeats", blurb: "global pulse" },
  { tag: "latin", label: "Latin", blurb: "ritmo" },
  { tag: "blues", label: "Blues", blurb: "bent notes" },
